                        ...
                        >
                          {section.items.map((item) => (
                            <li key={item.name} className="flow-root">
                              <p
                                onClick={() => {
                                  // Navigate to selected category/product page
                                            ...
                                            <li key={item.name} className="flex">
                                              <p
                                                onClick={() => {
                                                  ...
                                                  close(); //  Close desktop dropdown menu after click
                                                }}
                    ...
                    <div>
                      <Avatar
                        ...
                        sx={{
                          bgcolor: "#3f51b5",
                          color: "white",
                          cursor: "pointer", // <-- tumhare code me crsor likha hua hai
                        }}
                      >
                        R
                      </Avatar>
                      ...
                      >
                        ...
                        <MenuItem onClick={() => {
                          ...
                          handleCloseUserMenu(); // dropdown close
                        }} >
                          My Order
                        </MenuItem>
                        <MenuItem onClick={handleCloseUserMenu}>
